      ...
      <h3>{EDITMODE ? "Update Your Ticket" : "Create New Ticket"}</h3>
        ...
        <label>
           ...
           <select name="category" value={formData.category} onChange={handleChange}>
              <option value="Hardware Problem">Hardware Problem
              </option>
              <option value="Software Problem">Software Problem
              </option>
        ...
        <input type="submit" className="btn max-w-xs" value={EDITMODE ? "Update Your Ticket" : "Create New Ticket"}/>
      </form>
    </div>
  );
};
